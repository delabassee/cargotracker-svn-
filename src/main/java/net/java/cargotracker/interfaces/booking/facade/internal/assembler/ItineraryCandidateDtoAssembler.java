...
public class ItineraryCandidateDtoAssembler {
    ...
    public RouteCandidate toDTO(Itinerary itinerary) {
        List<net.java.cargotracker.interfaces.booking.facade.dto.Leg> legDTOs =
    ...
    protected net.java.cargotracker.interfaces.booking.facade.dto.Leg toLegDTO(Leg leg) {
        ...
        return new net.java.cargotracker.interfaces.booking.facade.dto.Leg(
                voyageNumber.getIdString(), from.getIdString(), to.getIdString(),
    ...
    public Itinerary fromDTO(RouteCandidate routeCandidateDTO,
        ...
        for (   net.java.cargotracker.interfaces.booking.facade.dto.Leg legDTO :
            ...
            Location from = locationRepository.find(new UnLocode(legDTO.getFrom()));
            Location to = locationRepository.find(new UnLocode(legDTO.getTo()));
            legs.add(new Leg(voyage, from, to, legDTO.getLoadTime(),
