...
public class LocationDtoAssembler {
    ...
    public net.java.cargotracker.interfaces.booking.facade.dto.Location toDTO(Location location) {
    ...
    public List<net.java.cargotracker.interfaces.booking.facade.dto.Location> toDTOList(
        ...
        List<   net.java.cargotracker.interfaces.booking.facade.dto.Location> dtoList =
