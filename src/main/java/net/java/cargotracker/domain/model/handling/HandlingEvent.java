 ...
 * {@link net.java.cargotracker.domain.model.cargo.TrackingId},
...
public class HandlingEvent implements Serializable {
	...
	public enum Type {
		 ...
		 * 
		 * @param voyageRequired
		 *            whether or not a voyage is associated with this event type
		 */
	 ...
	 *            completion time, the reported time that the event actually
	 *            happened (e.g. the receive took place).
	 * @param registrationTime
	 *            registration time, the time the message is received
	 * @param type
	 *            type of event
	 * @param location
